...
function Item({ title, videoUrl, stack, link, detail }) {
    return (
        <div>
            ...
            <dialog id={detail.gameName} className='modal border-2 border-stone-900 rounded-md overflow-auto bg-white px-10 py-5'>
                ...
                <h1 className='text-xl md:text-2xl mb-3 md:mb-3 font-bold'>Project Contribution</h1>
                <ul className='list-inside text-gray-600 list-disc'>
